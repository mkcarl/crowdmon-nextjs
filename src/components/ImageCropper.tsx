import {Alert, Box, Button, Divider, Grid, Paper, Skeleton, Typography} from "@mui/material";
import {centerCrop, makeAspectCrop, PixelCrop, ReactCrop} from "react-image-crop";
                        ...
                        >
                            <Box component={"div"} hidden={!props.completed}>
                                <ReactCrop onChange={() => {}} disabled>
                                    <Box
                                        component={"img"}
                                        src={"https://res.cloudinary.com/dmqxgg2mj/image/upload/v1688451174/crowdmon-website-assets/done_gpcplj.jpg"}
                                        onLoad={onImageLoad}
                                        loading={"lazy"}
                                        sx={{
                                            width: "auto",
